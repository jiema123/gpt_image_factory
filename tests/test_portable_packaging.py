...
class PortablePackagingTests(unittest.TestCase):
    ...
    def test_ci_workflow_avoids_github_unsupported_job_hashfiles_if(self) -> None:
        ...
        self.assertIn("github.repository == 'jiema123/gpt_image_factory'", text)
    ...
    def test_windows_portable_packaging_files_define_self_contained_bundle(self) -> None:
        ...
        self.assertNotIn("gpt-image-factory-portable-launcher", launcher_text)
        ...
        self.assertIn("https://github.com/jiema123/gpt_image_factory/releases/latest/download/latest.json", updater_helper_text)
        ...
        self.assertIn("gpt-image-factory_windows_portable_x64_", updater_helper_text)
    ...
    def test_macos_portable_packaging_files_define_arch_specific_bundles(self) -> None:
        ...
        updater_text = updater.read_text(encoding="utf-8")
        self.assertIn("https://github.com/jiema123/gpt_image_factory/releases/latest/download/latest.json", updater_text)
        ...
        self.assertIn("gpt-image-factory_macos_portable_${PACKAGE_ARCH}_", updater_text)
    ...
    def test_macos_standard_app_packaging_builds_unsigned_dmg(self) -> None:
        ...
        self.assertIn('DMG_NAME="GPT-IMAGE-FACTORY-macos-${PACKAGE_ARCH}-${SAFE_VERSION}.dmg"', build_text)
    ...
    def test_windows_standard_app_zip_packaging_is_not_an_installer(self) -> None:
        ...
        build_text = build_script.read_text(encoding="utf-8")
        self.assertIn('$BundleName = "GPT-IMAGE-FACTORY-windows-x64"', build_text)
    ...
    def test_portable_release_workflow_runs_after_ci_success(self) -> None:
        ...
        self.assertIn("GPT-IMAGE-FACTORY-macos-arm64-${release_version}.dmg", text)
        self.assertIn("GPT-IMAGE-FACTORY-macos-x64-${release_version}.dmg", text)
        self.assertIn("GPT-IMAGE-FACTORY-windows-x64_${release_version}.zip", text)
        self.assertIn('release_version="${RELEASE_TAG#v}"', text)
        self.assertIn("- Windows x64：gpt-image-factory_windows_portable_x64_${release_version}.zip", text)
        self.assertNotIn("- Windows x64：`gpt-image-factory_windows_portable_x64_${release_version}.zip`", text)
